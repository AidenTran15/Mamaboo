...
"""
Script tạo bảng 'penalty_records' trên DynamoDB.
Chạy: python create_penalty_table.py

Bảng lưu lịch sử hình phạt của nhân viên.
...
Suggested item shape:
{
  ...
  'date': '2025-11-04',             # ngày phạt (YYYY-MM-DD)
  'penaltyLevel': '1',               # mức độ phạt: 1|2|3|4|5
  'reason': 'Đi trễ nhiều lần',     # lý do phạt
